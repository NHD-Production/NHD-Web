...
function PopGallery({ title,images }) {
  return (
    <div className="w-full h-[30rem] max-w-[50rem] xl:w-[50rem] bg-white rounded-lg p-8 overflow-hidden">
      <h2 className="font-bold uppercase md:text-left text-center">{title? title : 'Gallery'}</h2>
      <div className="py-5 h-full">
        <div className="flex  flex-wrap overflow-auto max-h-[25rem] gap-2 md:gap-5">
