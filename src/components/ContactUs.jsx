...
function ContactUs() {
  return (
    <div className='flex flex-col sm:flex-row sm:p-5 relative'>
        <div className="w-full bg-black/60 sm:w-1/2 flex flex-col justify-center items-start p-8">
        ...
        <div className="w-full sm:w-1/2 bg-slate-400">
            <div className="w-full sm:w-[45%] h-[80%] bg-white sm:absolute ms:mapcont flex flex-col-reverse sm:flex-row  justify-start items-center ">
                ...
                <iframe className="h-full w-full" frameborder="0"  marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Kolkata&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                </div>
            </div>
        </div>
    </div>
