       ...
       {({
         ...
         /* and other goodies */
          ...
          <form className="flex flex-col py-7 gap-4 justify-center items-start w-full xl:w-[80%]  " onSubmit={handleSubmit}>
           ...
           <select
        className="block w-full  md:w-[30%] h-[3rem] bg-white/20  border border-fuchsia-700 shadow-xl px-1 focus:outline-none focus:border-blue-500" name="type"  onChange={handleChange}
        onBlur={handleBlur}
        value={values.type}>
