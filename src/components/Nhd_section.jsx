  ...
  return (
    <div className="flex flex-wrap sm:h-full">
      <div className="w-full sm:w-1/2 md:w-1/4 px-2 py-2 sm:h-full ">
        <div className=" h-full flex flex-col rounded-xl bg-gradient-to-r backdrop-blur-md bg-white/20 items-center hover:scale-[1.01] transform transition-scale duration-200 cursor-pointer p-4">
      ...
      <div className="w-full sm:w-1/2  md:w-1/4 px-2  py-2 sm:h-full">
        <div className="flex h-full  flex-col rounded-xl bg-gradient-to-r backdrop-blur-md bg-white/20 items-center hover:scale-[1.01] transform transition-scale duration-200 cursor-pointer p-4">
      ...
      <div className="w-full sm:w-1/2 md:w-1/4 px-2 py-2  sm:h-full">
        <div className="flex h-full  flex-col rounded-xl bg-gradient-to-r backdrop-blur-md bg-white/20 hover:scale-[1.01] transform transition-scale duration-200 cursor-pointer p-4">
