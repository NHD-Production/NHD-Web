...
function Nhd_section() {
  return (
    <div className="flex  flex-wrap sm:h-full">
      <a href="/nhdlive" className="w-full h-full sm:w-1/2 md:w-1/4 px-2 py-2 sm:h-full " target="_blank" rel="noopener noreferrer">
      ...
      <a href="/nhdstudio" className="w-full sm:w-1/2  md:w-1/4 px-2  py-2 sm:h-full" target="_blank" rel="noopener noreferrer">
      ...
      <a href="/nhdproduction" className="w-full sm:w-1/2 md:w-1/4 px-2 py-2  sm:h-full" target="_blank" rel="noopener noreferrer">
      ...
      <a href="/nhdclasses" target="_blank" className="w-full sm:w-1/2  md:w-1/4 px-2 py-2  sm:h-full" rel="noopener noreferrer">
