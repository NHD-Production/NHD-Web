...
function Nhd_section() {
  return (
    <div className="flex flex-wrap h-full ">
      <div className="w-full sm:w-1/2 md:w-1/4 px-2 h-full">
        <div className=" h-full flex flex-col rounded-xl bg-gradient-to-r backdrop-blur-md bg-white/20 items-center hover:scale-125 transform transition-transform duration-100 cursor-pointer p-4">
      ...
      <div className="w-full sm:w-1/2  md:w-1/4 px-2 h-full ">
        <div className="flex h-full  flex-col rounded-xl bg-gradient-to-r backdrop-blur-md bg-white/20 items-center hover:scale-125 transform transition-transform duration-100 cursor-pointer p-4">
      ...
      <div className="w-full sm:w-1/2 md:w-1/4 px-2 h-full ">
        <div className="flex h-full  flex-col rounded-xl bg-gradient-to-r backdrop-blur-md bg-white/20 hover:scale-125 transform transition-transform duration-100 cursor-pointer p-4">
